 ...
 implements HorlogeOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("afficher", new java.lang.Integer (0));
    _methods.put ("alarme", new java.lang.Integer (1));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 1:  // Horloge/alarme
       {
         String wakeup = in.read_string ();
         String $result = null;
         $result = this.alarme (wakeup);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }
